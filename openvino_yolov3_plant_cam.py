...
model_xml = "plant_disease/yolov3_plant_model.xml"
...
DESCRIPTION = {"strawberry_healthy": "草莓很健康，恭喜啦！", "strawberry_Leaf_scorch": "您的草莓得了叶焦病，请节哀！"}
    ...
    while cap.isOpened():
        ...
        for obj in objects:
            ...
            if confidence > 0.2:
                ...
                cv2.rectangle(image, (obj.xmin, obj.ymin), (obj.xmax-10, obj.ymax-10), box_color, box_thickness)
